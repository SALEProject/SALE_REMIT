<?php 
	...
	class Tfrm_NonStandardContractDetailsDLG extends TForm
	{
		var $ID_Table1Report = 0;
		...
		function showOrderDetails($ID_Table1Report)
		{
			$this->ID_Table1Report = $ID_Table1Report;
			$this->refreshData();
			$this->showModal();
		}
		...
		function refreshData()
		{
			...
			$ds = $db->select('REMIT', 'getTable1ReportDetails', array('Arguments' => array('ID_Table1Report' => $this->ID_Table1Report)));
				
			if ($ds == null || ($ds != null && $ds->RowsCount == 0))
			{
				TQuark::instance()->browserAlert($this->ID_Table1Report);
