...
class TsaleDesktop extends TDesktop
{
	...
	function generateHTML()
	{
		...
		return	//'<span style="font-size: 56px; color: white">'.$this->Caption.'</span>'.
				...
				'				<img src="themes/sale/logo-remit.png" width="100px" /> '.
				'			</a> '.
				'		</div> '.
